...
try {
    ...
    # 設置所有可能的 TLS 版本
    Write-Output "設置所有可能的 TLS 版本..."
    [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12 -bor `
                                                  [Net.SecurityProtocolType]::Tls11 -bor `
                                                  [Net.SecurityProtocolType]::Tls
    Write-Output "TLS 版本設置完成"
    ...
    Start-Process -FilePath $chromeInstaller -ArgumentList "/silent /install"
    ...
    Start-Process -FilePath $telegramInstaller -ArgumentList "/verysilent"
    Write-Output "Telegram 安裝完成"

    # 安裝 Skype
    Write-Output "開始安裝 Skype..."
    ...
    Start-Process -FilePath $skypeInstaller -ArgumentList "/verysilent"
    Write-Output "Skype 安裝完成"
    ...
    Start-Process -FilePath $vscodeInstaller -ArgumentList "/verysilent /mergetasks=!runcode"
    ...
    Start-Process -FilePath $sandboxieInstaller -ArgumentList "/verysilent"
